...
| ---- | ------------ | ------------ | ---- | ------------------ | ------------ | ------------ | ------------------ | ---- | ------------ | ------------ | ---- |
| GND  | SSTXp1+      | SSTXp1-      | VBUS | CC1                | Dp1+         | D-           | SBU1               | VBUS | RX2-         | RX2+         | GND  |
| 地线 | 差分信号TX正 | 差分信号TX负 | 电源 | 判断设备插入的方向 | USB2.0D+兼容 | USB2.0D-兼容 |                    | 电源 | 差分信号RX负 | 差分信号RX正 | 地线 |
| 地线 | 差分信号RX正 | 差分信号RX负 | 电源 |                    | USB2.0D-兼容 | USB2.0D+兼容 | 判断设备插入的方向 | 电源 | 差分信号TX正 | 差分信号TX正 | 地线 |
| GND  | RX1+         | RX1-         | VBUS | SBU2               | D-           | D+           | CC2                | VBUS | SSTXp2-      | SSTXp2+      | GND  |
